...
*** TODO 技能机制,目标选择[54%]
**** DONE 范围内最远的敌人
target_type: FAREST_ENEMY
**** DONE 范围内血量(百分比)最多的敌人
target_type: MOST_HP_ENEMY MOST_HP_PERCENT_ENEMY
**** DONE 范围内血量(百分比)最少的敌人
target_type: LEAST_HP_ENEMY LEAST_HP_PERCENT_ENEMY
**** DONE 范围内移动速度(当前值)最快的敌人
target_type: FASTEST_ENEMY
**** DONE 范围内移动速度(当前值)最慢的敌人
target_type: SLOWEST_ENEMY
**** Aaron 范围内目标体型最大的敌人
**** Aaron 范围内目标体型最小的敌人
**** Aaron 范围内移动路程最短的敌人
**** Aaron 范围内移动路程最远的敌人
**** DONE 范围内特定标签的敌人
target_type: ENEMY_HAS_TAG

target_type_arg(新加列): tag
**** Aaron 范围内特定标签的友军
